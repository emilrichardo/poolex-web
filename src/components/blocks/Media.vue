<template>
  <section
    :id="content?.id"
    :class="`${
      !card_web3 && !card_investment ? padding[content?.internal_margin] : ''
    }`"
    :style="`${
      !content?.background?.Gradient && content?.background?.Background_color
    ...
    >
      <div
        v-if="
          ...
          content?.style === 'box-right-floating'
        "
        :class="` absolute bottom-0 z-0 h-full ${
          content?.style === 'box-right' ||
          content?.style === 'box-right-caption' ||
          content?.style === 'box-right-floating'
            ? 'right-0'
      ...
      <div
        ...
        :style="`${
          card_with_color ? 'align-items: normal;' : 'align-items:center'
        }`"
      >
        <div
          :class="`block-image rounded-lg ${videoOpen && 'bg-black'}  ${
            content?.style === 'box-right-caption' ||
            content?.style === 'box-left-caption'
              ? 'lg:absolute lg:bottom-0 lg:h-[calc(100%_+_theme(spacing.14))] xl:h-[calc(100%_+_theme(spacing.32))]'
              : 'relative'
          }  ${card_investment && 'md:w-1/2 '} ${
            content?.image && 'flex flex-col items-center justify-center'
        ...
        >
          ...
          <NuxtImg
            :class="`w-[calc(150%_+_300px)] aspect-square h-auto bottom-0 z-10 hidden ${
              card_web3
          ...
          <NuxtImg
            :class="`w-full  mt-auto ${
              card_web3 || card_investment ? 'lg:hidden' : 'flex'
            } ${videoOpen && 'opacity-0'} ${
            ...
            :src="content?.image?.image?.data?.attributes?.url"
            :alt="content?.image?.image_title"
            :style="`${card_with_color ? 'max-heigth:500px;' : ''}
          `"
          />
          <div
            v-if="content?.video"
          ...
          <div
            ...
            :class="`text-white image-caption w-full md:w-1/2 lg:absolute -bottom-12 bg-product px-5 py-6 md:px-12 md:py-10 rounded-b-lg lg:rounded-b-none ${
        ...
        <div
          :class="`caption items-center relative background_text
         ${
           (content?.style === 'box-right-caption' ||
             content?.style === 'box-left-caption') &&
