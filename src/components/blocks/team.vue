<template>
  ...
  <section v-else class="team bg-[#F1F1F7] py-24">
    <div class="container">
      ...
      <div
        v-if="teamData.team"
        class="team-grid grid place-content-center col-1 gap-[40px] md:gap-8"
      >
        <div
        ...
        >
          <div
            ...
            :class="`image max-w-[180px] sm:max-w-[280px] flex-none relative ${
              item?.id % 2 !== 0
          ...
          <div
            :class="`text px-8 lg:px-0 ${
              item?.id % 2 !== 0 && 'order-2 md:order-1 md:text-right'
            }`"
          >
            ...
            <p
              :class="`text-sm lg:text-xl font-light text-dark-200  ${
                item?.id % 2 !== 0 ? 'lg:pl-16 ' : 'lg:pr-16'
              }`"
              v-if="item.body"
            >
              {{ item.body }}
